...
> Note that the knowledge for each level is cumulative; being at level *n*
> implies that you also know  everything from the levels lower than *n*
...
- [X] Has actually written tools and scripts, added bonus if they've been published.
